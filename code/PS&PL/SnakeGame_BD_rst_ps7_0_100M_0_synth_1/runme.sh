...
HD_PWD='C:/SOC_Final_Project_Snake_Game/SnakeGame/SnakeGame.runs/SnakeGame_BD_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeGame_BD_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SnakeGame_BD_rst_ps7_0_100M_0.tcl
