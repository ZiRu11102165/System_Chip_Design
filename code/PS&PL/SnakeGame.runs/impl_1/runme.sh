...
HD_PWD='C:/SOC_Final_Project_Snake_Game/SnakeGame/SnakeGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeGame_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SnakeGame_BD_wrapper.tcl -notrace
