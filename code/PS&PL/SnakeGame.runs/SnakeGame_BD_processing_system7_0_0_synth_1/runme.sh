...
HD_PWD='C:/SOC_Final_Project_Snake_Game/SnakeGame/SnakeGame.runs/SnakeGame_BD_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeGame_BD_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SnakeGame_BD_processing_system7_0_0.tcl
